    ...
    <div class="row content-container">
                                    ...
                                    <div class="panel-body">
                                        <ul class="nav navbar-nav">
                                            ...
                                            <li>
                                                ...
                                                <div class="purple-passion col-md-6 theme" title="purple-passion" @click="changeTheme('purplePassion')">
        ...
        <div class="container-fluid">
            <%--<div class="grid-stack">--%>
                <div v-for="item in widgets" v-html="tableHtml[item.chartId]" v-bind:style="{ overflow: scrollType ,width:item.width, height:item.height, transform: 'translate(' + item.datax + 'px,' + item.datay + 'px)' }" class="draggable" v-bind:chartType="item.chartType" v-bind:id="item.id" v-bind:chartId="item.chartId" v-bind:data-x="item.datax" v-bind:data-y="item.datay">
