    ...
    <div class="row content-container">
        ...
        <div class="container-fluid">
            <%--<div class="grid-stack">--%>
                <div v-for="item in widgets" v-bind:style="{ width:item.width, height:item.height, transform: 'translate(' + item.datax + 'px,' + item.datay + 'px)' }" class="draggable" v-bind:chartType="item.chartType" v-bind:id="item.id" v-bind:chartId="item.chartId" v-bind:data-x="item.datax" v-bind:data-y="item.datay" >
