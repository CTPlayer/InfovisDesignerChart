define(function(){    
                                            ...
                                            '<div>',
                                                ...
                                                '<form role="form">',
                                                    '<div class="form-group form-group-sm">',
                                                        '<label >内容&nbsp;&nbsp;</label>',
                                                        '<input class="form-control" v-model="titleContent">',
                                                    '</div>',
                                                    '<div class="form-group form-group-sm">',
                                                        '<label >上边距&nbsp;&nbsp;</label>',
                                                        '<input type="number" class="form-control" v-model="titleTop">',
                                                    '</div>',
                                                    '<div class="form-group form-group-sm">',
                                                        '<label >位置&nbsp;&nbsp;</label>',
                                                        '<select class="form-control" v-model="titleX">',
                                                            '<option>left</option>',
                                                    ...
                                                    '<div class="form-group form-group-sm">',
                                                        '<label >字体&nbsp;&nbsp;</label>',
                                                        '<select class="form-control" v-model="titleFontFamily">',
                                                    ...
                                                    '<div class="form-group form-group-sm">',
                                                        '<label >字号&nbsp;&nbsp;</label>',
                                                        '<input type="number" class="form-control" v-model="titleFontSize">',
                                                    '</div>',
                                                    '<div class="form-group form-group-sm">',
                                                        '<label >粗细&nbsp;&nbsp;</label>',
                                                        '<select class="form-control" v-model="titleFontWeight">',
                                                    ...
                                                    '<div class="form-group form-group-sm">',
                                                        '<label >风格&nbsp;&nbsp;</label>',
                                                        '<select class="form-control" v-model="titleFontStyle">',
                                                            '<option>normal</option>',
                                                    ...
                                                    '<div class="form-group form-group-sm">',
                                                        '<label >文字颜色&nbsp;&nbsp;</label>',
                                                        '<input type="text" id="titleFontColor" v-model="titleFontColor"/>',
                                                    '</div>',
                                                '</form>',
                                            '</div>',
                                            // '<div>',
    ...
    var tableAndConfigOfPie = function(){
        var table = ['<ul class="nav nav-tabs" role="tablist">',
                    ...
                    '<div class="form-group form-group-sm">',
                    '<label >位置&nbsp;&nbsp;</label>',
                    '<select class="form-control" data-bind="options: titleX, value: selectedX, valueUpdate: \'keyup\'"></select>',
                    '</div>',
                    '<div class="form-group form-group-sm">',
                    '<label >字体&nbsp;&nbsp;</label>',
